...
void ivad_write_settings(bool for_init)
{
  ...
  ivad_write(IVAD_REGISTER_PROPERTY, IVAD_SETTING_BRIGHTNESS_DRIVE, CURRENT_CONFIG[CONFIG_OFFSET_BRIGHTNESS_DRIVE]);
  ...
  */
  ...
  switch (ivad_setting)
  {
    ...
    case IVAD_SETTING_PARALLELOGRAM:
      ...
      break;
    case IVAD_SETTING_BRIGHTNESS_DRIVE:
      if (value < IVAD_BRIGHTNESS_DRIVE_MIN) return 2;
      if (value > IVAD_BRIGHTNESS_DRIVE_MAX) return 3;

      CURRENT_CONFIG[CONFIG_OFFSET_BRIGHTNESS_DRIVE] = value;
      break;
...
void settings_load()
{
  ...
  CURRENT_CONFIG[CONFIG_OFFSET_BRIGHTNESS_DRIVE] = EEPROMwl.read(CONFIG_OFFSET_BRIGHTNESS_DRIVE);
...
void settings_store()
{
  ...
  EEPROMwl.update(CONFIG_OFFSET_BRIGHTNESS_DRIVE, CURRENT_CONFIG[CONFIG_OFFSET_BRIGHTNESS_DRIVE]);
...
void settings_reset_default()
{
  ...
  CURRENT_CONFIG[CONFIG_OFFSET_BRIGHTNESS_DRIVE]   = 0xC0; // Used to be 0x40
